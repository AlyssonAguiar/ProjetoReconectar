...
$sql = "UPDATE user SET nomecompleto='$nomecompleto', email='$email', datanascimento='$datanascimento', endereco='$endereco', formacao='$formacao', experienciapro='$experienciapro', competencia='$competencia', linkedin='$linkedin', CEP='$CEP', rua='$rua', bairro='$bairro', cidade='$cidade', uf='$uf', foto='$foto' where CPF = {$_SESSION['CPF']}";
